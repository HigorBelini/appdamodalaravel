...
@section('content')
  ...
  <pagina tamanho="12">
    ...
    <painel titulo="Usuários cadastrados">
     <tabela-lista
      ...
      criar="#criar" detalhe="/administrador/usuarios/" editar="/administrador/usuarios/" deletar="/administrador/usuarios/" token="{{ csrf_token() }}" modal="sim"
  ...
  <modal nome="adicionar" titulo="Adicionar">
      <formulario id="formAdicionar" css="" action="{{route('usuarios.store')}}" method="post" enctype="multipart/form-data" token="{{ csrf_token() }}">
        ...
        <div class="form-group">
          <label for="admin">>Gostaria de salvar este usuário como administrador?</label>
  ...
  <modal nome="editar" titulo="Editar">
      <formulario id="formEditar" css="" v-bind:action="'/administrador/usuarios/' + $store.state.item.id" method="put" enctype="multipart/form-data" token="{{ csrf_token() }}">
